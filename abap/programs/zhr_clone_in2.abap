...
* INCLUDE TOP
*--------------------------------------------------------------------*
INCLUDE zhr_clone_in2_top.

*--------------------------------------------------------------------*
* INCLUDE SELECTION-SCREEN
*--------------------------------------------------------------------*
INCLUDE zhr_clone_in2_sel.

*--------------------------------------------------------------------*
* INCLUDE FORMS
*--------------------------------------------------------------------*
INCLUDE zhr_clone_in2_f00.
...
FORM validate_input.
  ...
  " Confirmación especial para modo Reemplazar
  IF p_mode = 'R' AND p_simul = abap_false.
    DATA(lv_answer) = '1'.
    CALL FUNCTION 'POPUP_TO_CONFIRM'
      EXPORTING
        titlebar              = 'Confirmación Requerida'
        text_question         = 'Modo REEMPLAZAR: Se borrarán todos los datos existentes de los empleados. ¿Continuar?'
        text_button_1         = 'Sí'
        text_button_2         = 'No'
        default_button        = '2'
...
FORM execute_upload.
  ...
  DATA: ls_params TYPE zcl_hr_upl_orchestrator=>gty_params.
  ...
  DATA(lv_warning) = lines( FILTER #( gt_results WHERE status = 'W' ) );
